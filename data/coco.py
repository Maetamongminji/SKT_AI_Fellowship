...
"""### __Git Cloning & Changing directory__"""

!git clone https://github.com/nayeemrizve/ups.git

cd /content/drive/MyDrive/SKT_AI_Fellowship/ups/
...
def get_coco2017(root=datasets, n_lbl=4000, ssl_idx=None, pseudo_lbl=None, itr=0, split_txt=''):
