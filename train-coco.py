...
Original file is located at
    https://colab.research.google.com/drive/1qlC5wYpT_PHBryt9j0Mb_S07E2M4DmeI

py 파일로 저장해서 ups 아래에 commit할 것
"""
...
def main():
    ...
    parser.add_argument('--lr', '--learning-rate', default=0.05, type=float,
                        help='initial learning rate, default 0.05') # 0.03 -> 0.05로 수정(데이터가 더 복잡하니까)
    ...
    parser.add_argument('--tau-p', default=0.70, type=float,
                        help='confidece threshold for positive pseudo-labels, default 0.70') # 추후 조정해볼 것
    parser.add_argument('--tau-n', default=0.05, type=float,
                        help='confidece threshold for negative pseudo-labels, default 0.05') # 추후 조정해볼 것
    parser.add_argument('--kappa-p', default=0.05, type=float,
                        help='uncertainty threshold for positive pseudo-labels, default 0.05') # 추후 조정해볼 것
    parser.add_argument('--kappa-n', default=0.005, type=float,
                        help='uncertainty threshold for negative pseudo-labels, default 0.005') # 추후 조정해볼 것
    parser.add_argument('--temp-nl', default=2.0, type=float,
                        help='temperature for generating negative pseduo-labels, default 2.0') # 추후 조정해볼 것
    ...
    parser.add_argument('--model-width', default=2, type=int, # 추후 조정해볼 것
                        help='model width for WRN-28')
    parser.add_argument('--model-depth', default=28, type=int, # 추후 조정해볼 것
    ...
    DATASET_GETTERS = {'coco'': get_coco2017}
